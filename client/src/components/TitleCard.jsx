      ...
      <div className="h-40  relative flex items-center overflow-hidden">
        <motion.div
          ...
          <p
            ...
            className="text-base sm:text-[3rem] py-10 font-bold text-indigo-400 bg-clip-text  bg-gradient-to-b from-white to-neutral-300">
            {revealText}
          </p>
        </motion.div>
        <motion.div
        ...
        <div
          ...
          <p
            className="text-base sm:text-[3rem] py-10 font-bold bg-clip-text text-transparent bg-[#a9a9ad]">
            {text}
          </p>
          <MemoizedStars />
        </div>
